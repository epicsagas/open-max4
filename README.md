...
> 출처: [블로터 「DOS 시절 '맥스'가 열어준 개발자의 삶」](https://www.bloter.net/news/articleView.html?idxno=21813) (2015-09-08) · [나무위키 「맥스」](https://namu.wiki/w/%EB%A7%A5%EC%8A%A4#s-5.2)
...
- 고증 팩(`web/public/data/era-1990s.json`)은 공개된 사실 정보를 정리한 것으로, 출처는 `docs/era-1990s.md`에 있습니다. LLM이 실존 인물에 대해 부정확한 내용을 생성할 수 있으니 사실 확인 용도로 쓰지 마세요.
